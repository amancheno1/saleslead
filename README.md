...
### Proyecto Único: Amz Kickstart by Pol Brullas
- Sistema centralizado para un único proyecto
- Gestión de miembros del equipo con roles y permisos
- Códigos de invitación para agregar nuevos miembros
